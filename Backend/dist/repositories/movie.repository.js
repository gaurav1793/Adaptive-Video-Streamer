...
exports.findStatus = exports.updateMovieStatus = exports.createMovie = void 0;
...
const findStatus = (movieId) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield prisma.movie.findFirst({
        where: {
            movieId
        }
    });
